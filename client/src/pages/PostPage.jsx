...
export const PostPage = () => {
    ...
    const removePostHandler = () => {
        try {
            ...
            toast('The post had been deleted.');
            navigate('/posts');
        } catch (error) {
            console.log(error);
        }
                ...
                <div className="w-1/3 p-8 bg-gray-700 flex flex-col gap-2 rounded-sm">
                    ...
                    >
                        <input
                            ...
                            placeholder="Comment"
                            className="text-black w-full rounded-sm bg-gray-400 border p-2 text-xs outline placeholder:text-gray-700"
                        />
                        <button
                            type="submit"
